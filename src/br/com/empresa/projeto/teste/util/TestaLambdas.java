...
//     		}	
//   		});
// reescrita do código acima com utilização do Lambda       
//        lista.sort( (Conta o1, Conta o2) -> {
//   	        return Integer.compare(o1.getNumero(), o2.getNumero());
//   		});
// simplificando ainda mais o código acima
//        lista.sort( (Conta o1, Conta o2) -> Integer.compare(o1.getNumero(), o2.getNumero()) );
// simplificando ainda mais o código        
         lista.sort((ct1, ct2) -> Integer.compare(ct1.getNumero(), ct2.getNumero()));        
...
//    	   @Override
//    	   public void accept(Conta ct1) {
//    		    System.out.println(ct1 + " , " + ct1.getTitular().getNome());
//    	   }
//       });
//     opcao 3       
//     lista.forEach( (Conta ct1) -> {
//  		    System.out.println(ct1 + " , " + ct1.getTitular().getNome());
//     });
//     opcao 4       
      lista.forEach( (ct1) -> System.out.println(ct1 + " , " + ct1.getTitular().getNome()) );
